...
class TransformerConfig(ModelParallelConfig):
    ...
    choices: "core_attn", "expert_fc1_act", "moe_act", "layernorm", "mla_up_proj", "mlp", "moe",
    ...
    "expert_fc1_act", "moe_act", "layernorm", "mla_up_proj", and "gdn_norm_out" use
    ...
    def __post_init__(self):
        ...
        if self.recompute_granularity == "selective":
            ...
            if "expert_fc1_act" in self.recompute_modules:
                ...
                if self.use_transformer_engine_op_fuser:
                    raise ValueError(
                        "expert_fc1_act in recompute_modules is not supported by the "
                        "Transformer Engine op fuser path."
                    )
                conflicting_modules = {"moe", "moe_act"}.intersection(self.recompute_modules)
        ...
        if self.moe_layer_recompute:
            ...
            if "expert_fc1_act" in self.recompute_modules:
                raise ValueError("expert_fc1_act cannot be combined with moe_layer_recompute.")
